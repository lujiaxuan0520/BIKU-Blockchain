...
class User(db.Model):
    ...
    coins = db.Column(db.Integer)   #币酷币数量
    ...
    movielikes = db.relationship('Movielike', backref='user')
...
class Movie(db.Model):
    ...
    likenum = db.Column(db.BigInteger)
    #  （设置外键第一步）
    ...
    movielikes = db.relationship("Movielike", backref='movie')
...
#     db.create_all()
    ...
    admin = Admin(
         name="admin",
         pwd=generate_password_hash("ljx52088"),
         is_super=0,
         role_id=1
    )
